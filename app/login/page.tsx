  ...
  return (
    <div className="mt-4 md:mt-8 space-y-3 text-center">
      <p className="mx-auto max-w-sm px-10 text-xs leading-relaxed text-muted-foreground">
        By clicking <span className="font-medium text-foreground">Continue</span>, you agree to our{' '}
        <Link
          href="/legal/terms"
  ...
  return (
    <main className="min-h-screen grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      ...
      <section className="hidden lg:flex flex-col justify-between px-16 py-14 bg-gradient-to-br from-[#998061] via-[#c7b89a] to-[#ded4bd] text-white">
        ...
        <div className="space-y-14">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-md text-sm leading-relaxed text-white/70">
              Track progress, stages, and important updates across your HubSpot CRM Projects,
              without chasing emails or status calls.
            </p>
          </div>
          ...
          <div className="space-y-6 max-w-md">
            <div>
              <p className="text-sm font-medium text-white/85">Delivery transparency</p>
              <p className="mt-1 text-sm text-white/70 leading-relaxed">
                See exactly what stage each project is at, what’s been completed, and what’s coming
                next.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-white/70 leading-relaxed">
                Important decisions and updates are surfaced clearly, so nothing gets lost.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="text-xs text-white/55">© {new Date().getFullYear()} Novocy Ltd</div>
      </section>
...
'
                >
                  <div className="md:space-y-2 space-y-1 mb-8">
                    <h2 className="text-xl md:text-2xl font-semibold tracking-tight">Log in</h2>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        canSubmit ? 'shadow-[0_8px_30px_rgba(153,128,97,0.30)]' : 'shadow-none',
